"""Strict canonical JSON primitives for instrument-contract artifacts.
...
Only genuine JSON values are accepted.  In particular, non-finite floats and
negative zero are rejected rather than normalized into a different value.
"""
...
def canonical_json_bytes(value: object) -> bytes:
    """Encode one value as the instrument-contract canonical JSON bytes."""
...
def sha256_bytes(value: bytes) -> str:
    """Return a lowercase SHA-256 digest for an immutable byte payload."""
